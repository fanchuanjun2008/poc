...
import com.yonyou.iuap.base.service.JsonResultService;
import com.yonyou.iuap.base.view.ViewListData;
import com.yonyou.iuap.bpm.tenant.TenantLimit;
...
public class ProcessService {
    ...
    public static void main(String[] args) {
    	...
    	ProcessService service=new ProcessService();
    	  ...
    	  try {
			HistoricProcessInstanceResponse json= service.startProcessByKey("35fa8dc0-6f48-11e6-bcf3-0242ac110003", "XHBOOKFORM-V20170814", "text", variables);
