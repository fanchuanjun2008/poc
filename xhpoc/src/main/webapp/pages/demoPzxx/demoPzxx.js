define(['text!pages/demoPzxx/demoPzxx.html','pages/demoPzxx/meta','css!pages/demoPzxx/demoPzxx.css','uuigrid'],function(html){
	var init=function(element){
		var listUrl = ctx+'/DEMO_PZXX/list';
		var delUrl = ctx+'/DEMO_PZXX/del/';
		var saveUrl = ctx+'/DEMO_PZXX/save';
