define(['text!pages/demoBdxx/demoBdxx.html','pages/demoBdxx/meta','css!pages/demoBdxx/demoBdxx.css','uuigrid'],function(html){
	var init=function(element){
		var listUrl = ctx+'/DEMO_BDXX/list';
		var delUrl = ctx+'/DEMO_BDXX/del/';
		var saveUrl = ctx+'/DEMO_BDXX/save';
