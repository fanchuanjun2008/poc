define(['text!pages/demoKhxx/demoKhxx.html','pages/demoKhxx/meta','css!pages/demoKhxx/demoKhxx.css','uuigrid'],function(html){
	var init=function(element){
		var listUrl = ctx+'/DEMO_KHXX/list';
		var delUrl = ctx+'/DEMO_KHXX/del/';
		var saveUrl = ctx+'/DEMO_KHXX/save';
