define(['text!pages/demoFhb/demoFhb.html','pages/demoFhb/meta','css!pages/demoFhb/demoFhb.css','uuigrid'],function(html){
	var init=function(element){
		var listUrl = ctx+'/DEMO_FHB/list';
		var delUrl = ctx+'/DEMO_FHB/del/';
		var saveUrl = ctx+'/DEMO_FHB/save';
