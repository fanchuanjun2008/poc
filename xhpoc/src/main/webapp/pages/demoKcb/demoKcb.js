define(['text!pages/demoKcb/demoKcb.html','pages/demoKcb/meta','css!pages/demoKcb/demoKcb.css','uuigrid'],function(html){
	var init=function(element){
		var listUrl = ctx+'/DEMO_KCB/list';
		var delUrl = ctx+'/DEMO_KCB/del/';
		var saveUrl = ctx+'/DEMO_KCB/save';
